...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene networked-scene="serverURL:  https://view.metagascar.com/wsapp; app: metagascar; room: metagascar; connectOnLoad: true; onConnect: onConnect; adapter: easyrtc; audio: false; video: false; debug: true;" >
        ...
        <a-entity environment="ground: noise;  lightPosition: 1 5 -2; groundColor: #553e35; groundColor2: #CFCFC1 ;ground: flat; dressing: none; playArea: 1000;"></a-entity>
        ...
        <a-entity gltf-model="url(https://metagascar.tfnlab.com/assets/download.glb.glb.glb?length=2&width=8&height=4&llength=4&lwidth=8&.glb)" position="25 0.05 100" scale="0.1 0.1 0.1"></a-entity>
        <a-entity gltf-model="url(https://metagascar.tfnlab.com/assets/download.glb.glb.glb?length=2&width=8&height=4&llength=4&lwidth=8&.glb)" position="25 0.05 150" scale="0.1 0.1 0.1"></a-entity>
    </a-scene>
